...
public class ContactManager {
	...
	public JSONArray search(ArrayList<String> numbers) throws JSONException {
        ...
        if (cur.getCount() > 0) {
	        while (cur.moveToNext()) {
                ...
                if (mimetype.equals(ContactsContract.CommonDataKinds.StructuredName.CONTENT_ITEM_TYPE)) {
            		...
            		String telNo = sanitiseNumber(cur.getString(colPhoneNumber));
	...
	private String sanitiseNumber(String number) {
